## ⚠️ NOTE
This export is filtered. Only **useful, business-critical files** are included:
- Entities, Enums, DbContext
- Services, Repositories, UnitOfWork
- Controllers

All Identity, Auth, Helpers, Extensions, Notifications, Views and other infrastructure
are **intentionally excluded** to keep the context short and relevant.
